...
function Home(props) {
  ...
  const getdata = async () => {
    const respons = await fetch('http://localhost:8000/Propaty');
        ...
        <div className="container">
          ...
          <OwlCarousel {...propertydata} id="property-carousel" className="owl-carousel owl-theme">
          {
              realestat.map((v) => (
                ...
                <Link to={`/Proparty/${v.id}`}>
                  <div className="carousel-item-b">

                    <div className="card-box-a card-shadow">
                      <div className="img-box-a">
                        <img src={v.image} alt className="img-a img-fluid" />
                      </div>
                      <div className="card-overlay">
                        <div className="card-overlay-a-content">
                          <div className="card-header-a">
                            <h2 className="card-title-a">
                              <a href="property-single.html">{v.name}</a>
                            </h2>
                          </div>
                          <div className="card-body-a">
                            <div className="price-box d-flex">
                              <span className="price-a">rent | $ {v.rate}</span>
                            </div>
